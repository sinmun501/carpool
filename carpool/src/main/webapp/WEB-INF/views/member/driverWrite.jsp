   ...
   <form:form commandName="driverCommand" action="driverWrite.do" enctype="multipart/form-data" id="driver_register_form">
      ...
      <ul>
         ...
         <li>
			...
			<input type="radio" name="driver_can_animal" value="y">가능
			<input type="radio" name="driver_can_animal" value="n" checked>불가능
		 </li>
		 <li>
			<label for="driver_can_smoking">흡연 여부</label>
			<input type="radio" name="driver_can_smoking" value="y">가능
			<input type="radio" name="driver_can_smoking" value="n" checked>불가능
		 </li>
		 <li>	
			<label for="driver_can_charge">충전기 유/무</label>
			<input type="radio" name="driver_can_charge" value="y">보유
			<input type="radio" name="driver_can_charge" value="n" checked>미보유
         </li>
         <li>
